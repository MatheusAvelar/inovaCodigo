            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Cadastro da Receita</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Adicione o valor</h6>
                        </div>
                        <div class="card-body">
                            <form class="user" action="cadastraSalario.php" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-user" id="inputSalario" name="inputSalario" placeholder="Valor" onKeyPress="return(moeda(this,'.',',',event))" required>
                                    </div>
                                </div>
                                <button class="btn btn-primary btn-user" onClick= "<?php if( isset($_POST['inputSalario'])){ cadastraSalario(); }?>">
                                    Adicionar
                                </button>
