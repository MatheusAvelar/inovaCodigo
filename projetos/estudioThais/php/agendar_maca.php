...
if ($errors) {
    ...
    if (!$stmt->execute()) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt->bind_param("ssssssssssssss", $nomeCliente, $estilo, $tamanho, $valor, $formaPagamento, $sinalPago, $descricao, $maca, $date, $startTime, $endTime, $usuarioId, $emailCliente, $status, $telefoneCliente);
